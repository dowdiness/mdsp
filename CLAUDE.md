...
- **Phase spec:** `docs/step0-instruction.md` — current phase spec
...
- Phase 0: proving MoonBit `wasm-gc` can generate audio in an `AudioWorklet`
...
- Compiled graph, not interpreted
